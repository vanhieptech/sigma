    ...
    <div className="container mx-auto py-8 max-w-4xl">
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Follow these steps to request deletion of data we&apos;ve collected through our Facebook app
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <p>
            In compliance with Facebook&apos;s Platform Policies and privacy regulations, 
            we provide a way for you to request deletion of your data from our systems.
          </p>
          
          <h3 className="text-lg font-medium mt-6">Step 1: Submit a Request</h3>
          <p>
            Send an email to <a href="mailto:privacy@yourdomain.com" className="text-primary hover:underline">
          ...
          <div className="bg-muted p-4 rounded-md mt-6">
            ...
            <p className="text-sm">
              We will process all deletion requests within 30 days, though most requests
