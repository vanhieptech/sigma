    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            Access tokens are sensitive credentials. Never share them publicly or commit them to version control.
          </AlertDescription>
        </Alert>
        ...
        <Tabs defaultValue="facebook" className="space-y-4">
          ...
          <TabsContent value="facebook">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p>If you don&apos;t already have one, create a Facebook Developer account at <a href="https://developers.facebook.com/" target="_blank" rel="noopener noreferrer" className="text-primary underline">developers.facebook.com</a>.</p>
                
                <h3 className="text-lg font-medium">Step 2: Create a Facebook App</h3>
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Go to the <a href="https://developers.facebook.com/apps/" target="_blank" rel="noopener noreferrer" className="text-primary underline">Facebook Apps page</a>.</li>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Go to &quot;Tools&quot; → &quot;Graph API Explorer&quot; in the left sidebar.</li>
                ...
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    ...
                    <p className="mt-2">Our application handles this automatically, but you need to make sure your access token has the correct permissions.</p>
                  </AlertDescription>
                </Alert>
                ...
                <h3 className="text-lg font-medium">Step 6: Get a Page Access Token (for Page content)</h3>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>Find the page you want to access in the response and copy its access token.</li>
                </ol>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Go to <a href="https://developers.facebook.com/tools/explorer/" target="_blank" rel="noopener noreferrer" className="text-primary underline">Tools → Graph API Explorer</a>.</li>
          ...
          <TabsContent value="twitter">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  How to create and use Twitter API access tokens
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <h3 className="text-lg font-medium">Step 1: Apply for a Twitter Developer Account</h3>
                <p>Apply for a Twitter Developer account at <a href="https://developer.twitter.com/en/apply-for-access" target="_blank" rel="noopener noreferrer" className="text-primary underline">developer.twitter.com</a>.</p>
                
                <h3 className="text-lg font-medium">Step 2: Create a Twitter Project and App</h3>
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Once approved, go to the <a href="https://developer.twitter.com/en/portal/dashboard" target="_blank" rel="noopener noreferrer" className="text-primary underline">Developer Portal</a>.</li>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>Select &quot;Read&quot; or &quot;Read and Write&quot; depending on your needs.</li>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  ...
                  <li>Under &quot;Authentication Tokens&quot;, click &quot;Generate&quot; for &quot;Access Token and Secret&quot;.</li>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    <p>Twitter has moved to API v2, which uses OAuth 2.0. For newer applications, you should:</p>
                    <ol className="list-decimal pl-5 mt-2">
                      <li>Generate a Bearer Token instead of using the older Access Token/Secret pair.</li>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>In your app settings, go to the &quot;User authentication settings&quot; section and click &quot;Set up&quot;.</li>
                  <li>Enable &quot;OAuth 2.0&quot;.</li>
                  <li>Set the redirect URL to your application&apos;s callback URL.</li>
                  <li>Select the required scopes (e.g., &quot;tweet.read&quot;, &quot;users.read&quot;).</li>
                  <li>Save your changes.</li>
                </ol>
          ...
          <TabsContent value="instagram">
            <Card>
              ...
              <CardContent className="space-y-4">
                <h3 className="text-lg font-medium">Step 1: Create a Facebook Developer Account</h3>
                <p>Instagram API access is managed through Facebook. Create a Facebook Developer account at <a href="https://developers.facebook.com/" target="_blank" rel="noopener noreferrer" className="text-primary underline">developers.facebook.com</a>.</p>
                ...
                <h3 className="text-lg font-medium">Step 5: Connect an Instagram Business Account</h3>
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Make sure your Instagram account is converted to a Business or Creator account.</li>
                  <li>Link your Instagram account to a Facebook Page (in Instagram app settings).</li>
                  <li>In your Facebook App, go to &quot;Instagram Graph API&quot; → &quot;Basic Display&quot;.</li>
                  <li>Click &quot;Add or Remove Instagram Testers&quot;.</li>
                  <li>Add your Instagram account as a tester and accept the invitation from your Instagram account.</li>
                </ol>
                
                <h3 className="text-lg font-medium">Step 6: Generate an Access Token</h3>
                <ol className="list-decimal pl-5 space-y-2">
                  <li>In your app, go to &quot;Instagram Graph API&quot; → &quot;Basic Display&quot; → &quot;User Token Generator&quot;.</li>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    <p>Instagram access tokens are valid for 60 days. For long-term access, you&apos;ll need to implement a token refresh mechanism.</p>
                  </AlertDescription>
                </Alert>
          ...
          <TabsContent value="tiktok">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  How to create and use TikTok API access tokens
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <h3 className="text-lg font-medium">Step 1: Join the TikTok for Developers Program</h3>
                <p>Register for a TikTok for Developers account at <a href="https://developers.tiktok.com/" target="_blank" rel="noopener noreferrer" className="text-primary underline">developers.tiktok.com</a>.</p>
                
                <h3 className="text-lg font-medium">Step 2: Create a TikTok App</h3>
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Log in to the <a href="https://developers.tiktok.com/app" target="_blank" rel="noopener noreferrer" className="text-primary underline">TikTok Developer Portal</a>.</li>
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Redirect users to the TikTok authorization URL:
                  ...
                  <li>After the user authorizes your app, TikTok will redirect to your redirect URI with an authorization code.</li>
                  <li>Exchange this code for an access token by making a POST request to:
                    <pre className="bg-muted p-2 rounded-md mt-1 overflow-x-auto">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li><strong>Client Key</strong>: Found in your app&apos;s dashboard</li>
                  <li><strong>Client Secret</strong>: Found in your app&apos;s dashboard</li>
                  <li><strong>Access Token</strong>: Obtained through the OAuth flow</li>
                </ul>
                ...
                <p>You can test your token using a tool like Postman or curl:</p>
                <pre className="bg-muted p-4 rounded-md overflow-x-auto">
                  curl -X GET &quot;https://open-api.tiktok.com/v2/user/info/&quot; \
                  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot;
                </pre>
                
                <h3 className="text-lg font-medium">Alternative: TikTok Live API</h3>
                <p>For TikTok Live streaming data, you can use the unofficial TikTok Live Client:</p>
                <ol className="list-decimal pl-5 space-y-2">
                  <li>Install the TikTok Live Client library:
                    <pre className="bg-muted p-2 rounded-md mt-1 overflow-x-auto">
                      npm install tiktok-live-connector
                    </pre>
                  </li>
                  <li>Use the library to connect to TikTok Live streams without needing an official API token:
                    <pre className="bg-muted p-2 rounded-md mt-1 overflow-x-auto">
